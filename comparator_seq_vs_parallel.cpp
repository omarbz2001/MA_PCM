...
int main(int argc, char** argv) {
    ...
    std::string file_path = "results/seq_vs_parallel/" + base_name + "_" + std::to_string(graph.size()) + "_" + std::to_string(num_threads) + "_" + std::to_string(cutoff) + ".txt";
    ...
    out << "Parallel\t" << parallel_time << "\t\t" << speedup << "\t\t" << efficiency << "\n";
    
    std::cout << "Sequential\t" << sequential_time << "\t\tN/A\t\tN/A\n";
    out << "Sequential\t" << sequential_time << "\t\tN/A\t\tN/A\n";
